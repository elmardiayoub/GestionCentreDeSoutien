<?php
   ...
   $query1 =" SELECT  niveau FROM  `apprenant`";
    ...
    <div class="col-sm-4 offset-md-3">
            <div class="input-group" style="margin-bottom:2em;">
              ...
              <div class="custom-file" >
                ...
                <label class="custom-file-label " for="inputGroupFile01"><?php echo($post["Imaage"])?></label>
              </div>
            </div>
         </div>
    <tbody>
      ...
      <tr>
        ...
        <td>
              <input  id="dateinscrp" class="form-control col-sm-7" type="date" 
                   value="<?php echo ($post["date_d'inscription"])?>" onblur="valider_date_insc()">
              <span id="err_dateProf2"></span>    
        </td>
      ...
      <tr>
        ...
        <td>
              <input id="numProf" class="form-control col-sm-7" type="text" 
                    value="<?php echo ($post["Num_tel"])?>"  onblur="valider_numero()" >
      ...
      <tr>
        ...
        <td>   
                ...
                <option selected><?php echo ($post["niveau"])?></option>
                <option>Maths</option>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                      <?php if(!$post["Archive"]) {?>
                          <a class="btn btn-secondary" href="Apprenants.php"  type="submit">OK</a>
                      <?php } else {?>
