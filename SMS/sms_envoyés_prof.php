<?php
   ...
   /// avec modele ::
  $query = 'SELECT * FROM message,modele,professeur,envoye2 
  		 AND modele.id_modele=message.id_modele 
  		 AND professeur.id = envoye2.id
  		 AND envoye2.id_msg = message.id_msg 
